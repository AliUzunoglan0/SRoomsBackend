...
namespace SRooms.Repository.Migrations
{
    ...
    [Migration("20230330223419_loginedit1")]
    partial class loginedit1
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SRooms.Core.Models.Login", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateTime = new DateTime(2023, 3, 31, 1, 34, 19, 728, DateTimeKind.Local).AddTicks(8360),
            ...
            modelBuilder.Entity("SRooms.Core.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CategoryId = 1,
                            CreateTime = new DateTime(2023, 3, 31, 1, 34, 19, 728, DateTimeKind.Local).AddTicks(8470),
                            Name = "Tukenmez Kalem",
                            Price = 200m,
                            Stock = 20,
                            UpdateTime = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
