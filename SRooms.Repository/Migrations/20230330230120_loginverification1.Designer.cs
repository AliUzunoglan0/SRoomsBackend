...
namespace SRooms.Repository.Migrations
{
    ...
    [Migration("20230330230120_loginverification1")]
    partial class loginverification1
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SRooms.Core.Models.Login", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateTime = new DateTime(2023, 3, 31, 2, 1, 19, 994, DateTimeKind.Local).AddTicks(7320),
            ...
            modelBuilder.Entity("SRooms.Core.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CategoryId = 1,
                            CreateTime = new DateTime(2023, 3, 31, 2, 1, 19, 994, DateTimeKind.Local).AddTicks(7440),
                            Name = "Tukenmez Kalem",
                            Price = 200m,
                            Stock = 20,
                            UpdateTime = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
