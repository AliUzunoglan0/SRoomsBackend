...
namespace SRooms.Repository.Migrations
{
    ...
    [Migration("20230330223934_loginedit3")]
    partial class loginedit3
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SRooms.Core.Models.Login", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateTime = new DateTime(2023, 3, 31, 1, 39, 34, 435, DateTimeKind.Local).AddTicks(4040),
            ...
            modelBuilder.Entity("SRooms.Core.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CategoryId = 1,
                            CreateTime = new DateTime(2023, 3, 31, 1, 39, 34, 435, DateTimeKind.Local).AddTicks(4150),
                            Name = "Tukenmez Kalem",
                            Price = 200m,
                            Stock = 20,
                            UpdateTime = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        ...
                        new
                        {
                            Id = 3,
                            CategoryId = 3,
                            CreateTime = new DateTime(2023, 3, 31, 1, 39, 34, 435, DateTimeKind.Local).AddTicks(4160),
                            Name = "Çizgili Defter",
                            Price = 150m,
                            Stock = 15,
                            UpdateTime = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
