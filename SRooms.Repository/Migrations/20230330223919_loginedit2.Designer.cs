...
namespace SRooms.Repository.Migrations
{
    ...
    [Migration("20230330223919_loginedit2")]
    partial class loginedit2
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SRooms.Core.Models.Login", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateTime = new DateTime(2023, 3, 31, 1, 39, 19, 611, DateTimeKind.Local).AddTicks(4670),
            ...
            modelBuilder.Entity("SRooms.Core.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CategoryId = 1,
                            CreateTime = new DateTime(2023, 3, 31, 1, 39, 19, 611, DateTimeKind.Local).AddTicks(4770),
                            Name = "Tukenmez Kalem",
                            Price = 200m,
                            Stock = 20,
                            UpdateTime = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        ...
                        new
                        {
                            Id = 2,
                            CategoryId = 2,
                            CreateTime = new DateTime(2023, 3, 31, 1, 39, 19, 611, DateTimeKind.Local).AddTicks(4780),
                            Name = "Çalışma Kitabı",
                            Price = 300m,
                            Stock = 10,
                            UpdateTime = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
